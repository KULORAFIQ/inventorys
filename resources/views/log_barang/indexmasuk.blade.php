...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.4.2/css/buttons.dataTables.min.css">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <table id="table_barang_masuk" class="table table-striped">
            <thead>
                <tr>
                    <th class="col-md-1">No</th>
                    <th class="col-md-3">Nama_barang</th>
                    <th class="col-md-3">jumlah_stok_masuk</th>
                    <th class="col-md-3">Tanggal data barang masuk</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($log_masuk as $no => $hasil)
                <tr>
                    <th>{{ $no + 1 }}</th>
